...
use SussexDev\Extrato\Api\Data\DataSearchResultsInterfaceFactory;
use SussexDev\Extrato\Model\ResourceModel\Data as ResourceData;
use SussexDev\Extrato\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \SussexDev\Extrato\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \SussexDev\Extrato\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \SussexDev\Extrato\Model\ResourceModel\Data\Collection $collection */
